...
// RequestOption is an option for the requests made by the openmev API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/openmev-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://xga-auction-system.workers.dev/")
}
...
func WithEnvironmentEnvironment1() RequestOption {
	return requestconfig.WithDefaultBaseURL("http://localhost:8787/")
}
