...
func TestAPIV1BidGetStatusWithOptionalParams(t *testing.T) {
	...
	_, err := client.API.V1.Bids.GetStatus(
		context.TODO(),
		"x",
		openmev.APIV1BidGetStatusParams{
			IncludeDetails: openmev.Bool(true),
		},
	)
	if err != nil {
