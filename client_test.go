...
func TestUserAgentHeader(t *testing.T) {
	...
	client.API.V1.Public.Auctions.GetHistory(context.Background(), openmev.APIV1PublicAuctionGetHistoryParams{})
	if userAgent != fmt.Sprintf("Openmev/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.API.V1.Public.Auctions.GetHistory(context.Background(), openmev.APIV1PublicAuctionGetHistoryParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.API.V1.Public.Auctions.GetHistory(cancelCtx, openmev.APIV1PublicAuctionGetHistoryParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.API.V1.Public.Auctions.GetHistory(deadlineCtx, openmev.APIV1PublicAuctionGetHistoryParams{})
		if err == nil {
